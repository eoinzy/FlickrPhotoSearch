 ...
 * Lots of boiler plate code, auto-generated in Android Studio:
...
//            view.performClick();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSubtitle = findViewById(R.id.fullscreen_image_subtitle);
        ...
        mSubtitle.setOnTouchListener(mDelayHideTouchListener);

        //Set values
        Bundle extras = getIntent().getExtras();
        if (extras != null) {
            String imgUrl = extras.getString(EXTRA_IMAGE_URL);
            String imgSubtitle = extras.getString(EXTRA_IMAGE_TEXT);

            mSubtitle.setText(imgSubtitle);
